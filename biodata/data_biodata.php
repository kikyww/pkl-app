        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="idcuy">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM tb_biodata WHERE status_pkl = 'Diterima' ORDER BY nama_mhs ASC";
                    ...
                    while ($row = mysqli_fetch_assoc($data)) {
                        ...
                        if ($_SESSION['status'] == 'Admin') {
                            ...
                            <div class='btn-group'>
                                ...
                                <a href='./edit_biodata.php?nim=$row[nim]' class='btn btn-warning'>Edit</a>
                                <a href='./hapus_biodata.php?nim=$row[nim]' onclick='return confirm(\" Hapus Data ini?\");' class='btn btn-danger'>Hapus</a>
                                </div>
                            </div>
                                </td>";
                        } else {
