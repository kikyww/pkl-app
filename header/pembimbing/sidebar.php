...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar" style="background-color:#252525;">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-item"><a class="nav-link" href="../surat/tambah_surat.php">
                    <svg class="nav-icon">
                    </svg> Surat Balasan PKL </a>
            <li class="nav-item"><a class="nav-link" href="../suratpenelitian/tambah_surat.php">
                    <svg class="nav-icon">
                    </svg> Surat Izin Penelitian </a>
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                ...
                <ul class="nav-group-items">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../laporan_sertifikat/index.php" target="_top">
                            <svg class="nav-icon">
                            </svg> Laporan Sertifikat </a></li>
                </ul>
            </li>
        </ul>
