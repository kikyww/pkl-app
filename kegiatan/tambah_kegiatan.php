...
<!--                 
                <input id="nim" name="nim" type="text" value="<?= $_SESSION['nim_user']; ?>" class="form-control" required> -->

                <div class="row mb-3" hidden>
                    <label class="col-sm-2 col-form-label">Penempatan </label>
                    <div class="col-sm-10">
                        <select class="form-select" id="piket" name='piket'>
                    </div>
                </div>
                <script>
...
<?php                           
            ...
            <!-- <div id="kegiatani" class="row mb-3">
                ...
                <div id="kegiatani" class="row mb-3">
                    <label for="kegiatani" class="col-sm-2 col-form-label">Kegiatan</label>
                    <div class="col-sm-10">
                        <textarea name="kegiatani" type="text" class="form-control"></textarea>
                        <div class="mt-3">
                            <div id="tombolii" class="btn btn-primary">Tambah Kegiatan</div>
