            ...
            <table class="table table-striped" id="idcuy">
                ...
                <tbody>
                    ...
                    if (isset($_GET['id_user'])) {
                        ...
                        $query = mysqli_query($konek, "SELECT * FROM tb_kegiatan LEFT JOIN tb_biodata ON tb_kegiatan.nim_kegiatan = tb_biodata.nim INNER JOIN tb_jadwal ON tb_kegiatan.jadwal_id = tb_jadwal.id_jadwal INNER JOIN tb_piket ON tb_jadwal.piket_id = tb_piket.id_piket WHERE tb_biodata.status_pkl = 'Diterima'");
                    } 
