        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="idcuy">
                ...
                <tbody>
                    ...
                    $query = "SELECT tb_biodata.nim AS nim, tb_biodata.nama_mhs AS nama_mhs, tb_absen.nim_absen AS nim_absen, SUM(kehadiran = 'hadir') AS jumlah_hadir, SUM(kehadiran = 'sakit') AS jumlah_sakit, SUM(kehadiran = 'izin') AS jumlah_izin FROM tb_biodata LEFT JOIN tb_absen ON tb_biodata.nim = nim_absen WHERE tb_biodata.status_pkl = 'Diterima' GROUP BY tb_biodata.nim";
                    ...
                    <td style='text-align:center'>$row[jumlah_izin]</td>";
                        if ($_SESSION['status'] != 'User') {
                            ...
                            <div class='btn-group'>
                            <a href='./cetak.php?nim_user=$row[nim]' class='btn btn-info d-flex align-items-center'>Cetak</a>
                            </div>
                            </div>
                            </td>";
                        } else {
