...
<section class="section">
        <div class="card">
            <div class="card-body">
              ...
              <form action="submit_absensi_user.php" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="tanggal" type="text" class="form-control" value="<?php date_default_timezone_set('Singapore'); echo date(' d-m-Y / H:i'); ?>" readonly>
                  </div>
                </div>
