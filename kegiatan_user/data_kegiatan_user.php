    ...
    <div class="card">
        <div class="card-body">
            ...
            <div style="display:flex; justify-content:space-between; margin-right: 35
                ...
                ?>
                <a class="btn btn-success" href="tambah_kegiatan_user.php">Tambah</a>
            </div>
            <table class="table table-striped" id="idcuy">
                ...
                <div class='btn-group'>
                    <a href='edit_kegiatan_user.php?id=$row[0]' class='btn btn-warning'>Edit</a>
                    <a href='hapus_kegiatan_user.php?id=$row[0]' onclick='return confirm(\" Hapus Kegiatan ini?\");' class='btn btn-danger'>Hapus</a>
                    </div>
                </div>
            </td>
        </tr>";
