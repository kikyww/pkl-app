...
if (isset($nim_user)) {
    $query = mysqli_query($konek, "SELECT * FROM tb_biodata LEFT JOIN tb_kegiatan ON tb_biodata.nim =  tb_kegiatan.nim_kegiatan LEFT JOIN tb_jadwal ON tb_kegiatan.jadwal_id = tb_jadwal.id_jadwal LEFT JOIN tb_piket ON tb_jadwal.piket_id = tb_piket.id_piket ORDER BY tb_kegiatan.tanggal ASC");
}
?>
