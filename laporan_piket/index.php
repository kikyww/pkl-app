        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="idcuy">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM tb_jadwal LEFT JOIN tb_biodata ON tb_jadwal.nim_jadwal = tb_biodata.nim LEFT JOIN tb_piket ON tb_jadwal.piket_id = tb_piket.id_piket WHERE status_pkl = 'Diterima' ORDER BY tanggal DESC";
