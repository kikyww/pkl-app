...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO tb_spenelitian (id_spen, penelitian_id, no_spen, tgl_spen, perihal_spen, lampiran) VALUES ('$idsurat', '$penelitian_id', '$no_spen', '$tgl_spen', '$perihal_spen', '$tujuan_spen', '$lampiran')";

    if (mysqli_query($konek, $sql)) {
        mysqli_query($konek, "UPDATE tb_penelitian SET p_status = '$status' WHERE id_penelitian = '$id'");
        echo "<script>alert(`Surat Penolakan Telah Dibuat`);</script>";
...
<section class="section">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Surat Penolakan</h5>
            <form method="POST">
                <div class="row mb-3">
                    <div class="col-sm-10" hidden>
                        <input name="penelitian_id" value="<?= $data['id_penelitian'] ?>" type="text" class="form-control">
                    </div>
                </div>
                <div class="row mb-3">
