...
session_start();
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($konek, "SELECT * FROM tb_surat LEFT JOIN tb_biodata ON tb_surat.biodata_id = tb_biodata.id_siswa WHERE tgl_masuk BETWEEN '$start_date' AND '$end_date' ORDER BY id_surat ASC");
    }
...
justify-content: center; align-items: center; margin:auto;">
        ...
        <div style="display:flex;">
            <div style="
justify-content: center; align-items: center; margin:auto;">
                <p style="font-size:22px; text-align: center;">Arsip Surat  Balasan Keluar</p>
                ...
                <table class='table table-stripped table-bordered mt-3 table-responsive demo'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan=3 style='text-align:center; vertical-align: middle;'>No. Surat</th>
                            <th rowspan=3 style='text-align:center; vertical-align: middle;'>No. Surat Terima</th>
                            <th rowspan=3 style='text-align:center; vertical-align: middle;'>Tanggal Terima Surat</th>
                            <th rowspan=3 style='text-align:center; vertical-align: middle;'>Penerima Surat</th>
                        </tr>
                    </thead>
                    <tbody>
...
<td style='text-align:center;' class='td1'>$data[no_surat]</td>
<td style='text-align:center;' class='td1'>$data[no_terima]</td>
<td style='text-align:center;' class='td1'>".date('d-m-Y', strtotime($data['tgl_terima']))."</td>
