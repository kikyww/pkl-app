...
justify-content: center; align-items: center; margin:auto;">
        ...
        <div style="display:flex;">
            <div style="
justify-content: center; align-items: center; margin:auto;">
                <p style="font-size:22px; text-align: center;">Arsip Surat Penelitian</p>
                ...
                <table class='table table-stripped table-bordered mt-3 table-responsive demo'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan=3 style='text-align:center; vertical-align: middle;'>Tanggal Surat Keluar</th>
                            <th rowspan=3 style='text-align:center; vertical-align: middle;'>Judul Penelitian</th>
                        </tr>
                    </thead>
                    <tbody>
...
<td style='text-align:center;' class='td1'>$data[no_spen]</td>
<td style='text-align:center;' class='td1'>$data[p_nama]</td>
<td style='text-align:center;' class='td1'>$data[p_instansi]</td>
<td style='text-align:center;' class='td1'>".date('d-m-Y', strtotime($data['tgl_spen']))."</td>
<td style='text-align:center;' class='td1'>$data[p_judul]</td>
</tr>";
                            }
