...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <br>
            <p>Berdasarkan pertimbangan kami, pada prinsipnya kami tidak dapat memberikan ijin kepada mahasiswa/ mahasiswi tersebut untuk mencari data informasi dalam menyelesaikan laporan skripsi Unit Pelayanan Pendapatan Daerah (UPPD) Banjarmasin 1, atas nama :
            <br>
            <table>
                <tr>
