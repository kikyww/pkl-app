...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Menindak lanjuti surat pengantar dari <?php echo $row['tujuan_spen'] ?> Tanggal <?php echo $row['tgl_spen'] ?> Nomor : <?php echo $row['tujuan_spen'] ?> perihal <?php echo $row['perihal'] ?></p>
            <br>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 5%">:</td>
                    <td style="width: 65%"><?= $row['p_status'] ?></td>
                </tr>
            </table>
            <br>
