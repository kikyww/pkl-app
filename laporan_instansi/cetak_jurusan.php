...
justify-content: center; align-items: center; margin:auto;">
        ...
        <div style="display:flex;">
            <div style="justify-content: center; align-items: center; margin:auto;">
                ...
                <p style="font-size:22px; text-align: center;"><?= $pen ?>, <?= $jurusan ?></p>
                ...
                <table class='table table-stripped table-bordered mt-3 table-responsive demo'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style='text-align:center; vertical-align: middle;'>Tanggal PKL</th>
                        </tr>
                        </tr>
                    </thead>
                    <tbody>
...
while ($data = mysqli_fetch_array($query)) {
    ...
    <tr>
        ...
        <td style='text-align:center;' class='td1'><?= date('d-m-Y' ,strtotime($data['tgl_masuk'])) ?> s/d <?= date('d-m-Y' ,strtotime($data['tgl_keluar'])) ?></td>
    </tr>
<?php } ?>
