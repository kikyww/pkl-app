...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <br>
            <p>Setelah kami pelajari dan pertimbangkan pada prinsip nya kantor Unit Pelayanan Pendapatan Daerah (UPPD) Banjarmasin 1 tidak dapat menerima calon Mahasiswa/i Magang dari <?php echo $row['asal_pendidikan'] ?>, Mahasiswa/i tersebut adalah </p>
            <br>
            <table>
                <tr>
